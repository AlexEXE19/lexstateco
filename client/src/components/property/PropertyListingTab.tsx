    ...
    <div className="space-y-6">
      ...
      >
        <FormField
          ...
          icon={<Home size={16} className="text-blue-200" />}
          type="text"
        ...
        <FormField
          ...
          icon={<Tag size={16} className="text-blue-200" />}
          type="number"
          placeholder="450000"
          value={price}
        ...
        <FormField
          ...
          icon={<MapPin size={16} className="text-blue-200" />}
          type="text"
        ...
        <FormField
          ...
          icon={<Ruler size={16} className="text-blue-200" />}
          type="number"
          placeholder="1800"
          value={size}
