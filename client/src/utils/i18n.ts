...
const translations: Translations = {
  en: {
    ...
    "properties.filter.toggle": "Filters",
    ...
    "properties.cloud.more": "More details",
    ...
    "listing.label.country": "Country",
    "listing.label.city": "City",
    "listing.label.address": "Address",
    ...
    "listing.label.bedrooms": "Bedrooms",
    "listing.label.bathrooms": "Bathrooms",
    "listing.label.status": "Status",
    "listing.label.type": "Property type",
    "listing.label.amenities": "Amenities",
    ...
    "listing.step.amenities": "Amenities & photos",
    "listing.step.label": "Step",
    "listing.step.next": "Next",
    "listing.step.back": "Back",
  ...
  ro: {
    ...
    "properties.filter.toggle": "Filtre",
    ...
    "properties.cloud.more": "Mai multe detalii",
    ...
    "listing.label.country": "Țară",
    "listing.label.city": "Oraș",
    "listing.label.address": "Adresă",
    ...
    "listing.label.bedrooms": "Dormitoare",
    "listing.label.bathrooms": "Băi",
    "listing.label.status": "Status",
    "listing.label.type": "Tip proprietate",
    "listing.label.amenities": "Facilități",
    "listing.label.upload": "Încarcă imagini (max 8)",
    "listing.submit": "Publică proprietatea",
    "listing.step.location": "Locație",
    "listing.step.details": "Detalii",
    "listing.step.amenities": "Facilități și fotografii",
    "listing.step.label": "Pasul",
    "listing.step.next": "Următorul",
    "listing.step.back": "Înapoi",
